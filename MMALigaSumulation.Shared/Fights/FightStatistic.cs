namespace MMALigaSumulation.Shared.Fights
{
    public class FightStatistic
    {
        ...
        public int KnockDownTimes { get; set; }
        public int KnockedDownOpponentTimes { get; set; }
